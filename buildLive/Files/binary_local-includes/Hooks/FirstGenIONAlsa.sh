...
NvidiaHDMI=$(lspci -nn | grep 'Audio' | grep '10de:0ac0')
...
DIGITALCARD=`aplay -l | grep 'VT1708S Digital' | awk -F: '{ print $1 }' | awk '{ print $2 }'`
DIGITALDEVICE=`aplay -l | grep 'VT1708S Digital' | awk -F: '{ print $2 }' | awk '{ print $5 }'`
