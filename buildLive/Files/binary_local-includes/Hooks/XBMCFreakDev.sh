...
echo "192.168.0.111:/volume1/misc/Videos /home/xbmc/Test nfs defaults 0 0" >> /etc/fstab
...
echo "192.168.0.111:/volume1/misc/TV\ Shows /home/xbmc/TV\ Shows nfs defaults 0 0" >> /etc/fstab
